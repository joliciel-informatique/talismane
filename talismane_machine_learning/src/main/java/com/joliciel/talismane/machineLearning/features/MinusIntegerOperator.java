 ...
 *
 */
public class MinusIntegerOperator<T> extends AbstractCachableFeature<T, Integer>implements IntegerFeature<T> {
	private IntegerFeature<T> operand1;
	private IntegerFeature<T> operand2;

	public MinusIntegerOperator(IntegerFeature<T> operand1, IntegerFeature<T> operand2) {
		super();
