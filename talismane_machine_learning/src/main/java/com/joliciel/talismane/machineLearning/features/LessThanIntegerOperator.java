 ...
 *
 */
public class LessThanIntegerOperator<T> extends AbstractCachableFeature<T, Boolean>implements BooleanFeature<T> {
  private IntegerFeature<T> operand1;
  private IntegerFeature<T> operand2;

  public LessThanIntegerOperator(IntegerFeature<T> operand1, IntegerFeature<T> operand2) {
    super();
