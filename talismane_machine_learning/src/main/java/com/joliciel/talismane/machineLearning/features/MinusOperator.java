 ...
 *
 */
public class MinusOperator<T> extends AbstractCachableFeature<T, Double>implements DoubleFeature<T> {
  private DoubleFeature<T> operand1;
  private DoubleFeature<T> operand2;

  public MinusOperator(DoubleFeature<T> operand1, DoubleFeature<T> operand2) {
    super();
