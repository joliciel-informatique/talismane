 ...
 *
 */
public class GreaterThanOrEqualsOperator<T> extends AbstractCachableFeature<T, Boolean>implements BooleanFeature<T> {
	private DoubleFeature<T> operand1;
	private DoubleFeature<T> operand2;

	public GreaterThanOrEqualsOperator(DoubleFeature<T> operand1, DoubleFeature<T> operand2) {
		super();
