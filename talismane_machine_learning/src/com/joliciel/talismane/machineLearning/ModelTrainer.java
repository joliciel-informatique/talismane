 ...
 *
 */
public interface ModelTrainer<T extends Outcome> {
	/**
	 * Return the MachineLearningModel trained using the CorpusEventStream provided.
	 ...
	 * @return
	 */
	public MachineLearningModel<T> trainModel(CorpusEventStream corpusEventStream, DecisionFactory<T> decisionFactory, List<String> featureDescriptors);
	 ...
	 * @return
	 */
	public MachineLearningModel<T> trainModel(CorpusEventStream corpusEventStream, DecisionFactory<T> decisionFactory, Map<String,List<String>> descriptors);
