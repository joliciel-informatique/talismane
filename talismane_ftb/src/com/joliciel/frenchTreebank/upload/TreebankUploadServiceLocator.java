...
public class TreebankUploadServiceLocator {
	private TreebankUploadServiceImpl treebankUploadService;
	private TreebankServiceLocator treebankServiceLocator;

    
	public TreebankUploadServiceLocator(TreebankServiceLocator treebankServiceLocator) {
		this.treebankServiceLocator = treebankServiceLocator;
	}


	public TreebankUploadService getTreebankUploadService() {
		if (treebankUploadService==null) {
			treebankUploadService = new TreebankUploadServiceImpl();
