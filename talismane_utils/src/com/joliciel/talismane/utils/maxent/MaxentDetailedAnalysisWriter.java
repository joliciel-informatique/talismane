...
public class MaxentDetailedAnalysisWriter implements AnalysisObserver {
	 ...
	 */
	@Override
	public void onAnalyse(Object event, List<FeatureResult<?>> featureResults, Collection<WeightedOutcome<String>> outcomes) {
		try {
			...
			for (WeightedOutcome<String> weightedOutcome : outcomes) {
				outcomeWeights.put(weightedOutcome.getOutcome(), weightedOutcome.getWeight());
			}
