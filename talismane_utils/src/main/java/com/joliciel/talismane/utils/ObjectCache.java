...
/**
 * A cache for storing objects so they don't have to be reloaded multiple times
 * from a datastore.
 * 
 * @author Assaf Urieli
 *
...
public interface ObjectCache {
  ...
  /**
   * If the Class and id provided already have an entity in the cache, return
   * it, otherwise put the entity provided in the cache and return it.
   */
  ...
  /**
   * Clear all entities out of the cache corresponding to a particular Class
   * only.
   */
