...
/**
 * A class for decisions made by the tokenizer.
 * @author Assaf Urieli
 *
 */
public enum TokeniserDecision implements TokenTag {
	/**
	...
	/**
	 * The current interval between two tokens separates them.
	 */
	DOES_SEPARATE,
	
	/**
	 * The current interval between two tokens doesn't separate them.
	 */
	DOES_NOT_SEPARATE
}