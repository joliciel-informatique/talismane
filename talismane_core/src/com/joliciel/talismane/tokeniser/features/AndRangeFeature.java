 ...
 * and returns true only if all of them satisfy the criterion.<br/>
 ...
 *
 */
public class AndRangeFeature extends AbstractTokenFeature<Boolean> implements BooleanFeature<TokenWrapper> {
