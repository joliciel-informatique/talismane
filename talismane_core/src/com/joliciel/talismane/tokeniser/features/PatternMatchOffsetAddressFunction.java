 ...
 *
 */
public final class PatternMatchOffsetAddressFunction extends AbstractCachableFeature<TokenPatternMatch, TokenWrapper> implements TokenAddressFunction<TokenPatternMatch> {
	...
	@Override
	public FeatureResult<TokenWrapper> checkInternal(TokenPatternMatch tokenPatternMatch, RuntimeEnvironment env) {
