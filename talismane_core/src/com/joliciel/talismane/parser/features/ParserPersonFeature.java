...
/**
 * The grammatical person of a given token as supplied by the lexicon, referenced by address.
 * @author Assaf Urieli
 *
 */
public class ParserPersonFeature extends AbstractParseConfigurationAddressFeature<String> implements StringFeature<ParseConfigurationAddress> {
	public ParserPersonFeature() {
		super();
