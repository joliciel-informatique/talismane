 ...
 *
 */
public class ParserLemmaFeature extends AbstractParseConfigurationAddressFeature<String> implements StringFeature<ParseConfigurationAddress> {
	
	public ParserLemmaFeature() {
		super();
