...
/**
 * The grammatical sub-category of a given token as supplied by the lexicon, referenced by address.
 * @author Assaf Urieli
 *
 */
public class ParserSubCategoryFeature extends AbstractParseConfigurationAddressFeature<String> implements StringFeature<ParseConfigurationAddress> {
	public ParserSubCategoryFeature() {
		super();
