...
public interface AnnotatorDependencyInjector {
	/**
	 * Inject dependencies into a token filter, if appropriate for the class in
	 * question. Will be called before
	 * {@link SentenceAnnotator#load(java.util.Map, java.util.List)}.
	 * 
	 * @param tokenFilter
	 *            the token filter into which we need to inject dependencies.
	 */
	public void injectDependencies(SentenceAnnotator tokenFilter);
}
