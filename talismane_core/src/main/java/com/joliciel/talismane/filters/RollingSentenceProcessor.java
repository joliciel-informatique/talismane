...
/**
 * A raw text processor which processes text block by block, applies text
 * markers, and returns SentenceHolders. These sentence holders will then be
 * used to detect the actual sentences.
 * 
 * @author Assaf Urieli
 */
public class RollingSentenceProcessor implements CurrentFileObserver {
	private static final Logger LOG = LoggerFactory.getLogger(RollingSentenceProcessor.class);
	...
	public RollingSentenceProcessor(String fileName, boolean processByDefault, TalismaneSession talismaneSession) {
	...
	public RollingSentenceProcessor(String fileName, TalismaneSession talismaneSession) {
		this(fileName, true, talismaneSession);
	}
	 ...
	 * 
	 * @param originalText
	 *            the next segment of original text
	 * @param textMarkers
	 *            the text markers corresponding this segment
