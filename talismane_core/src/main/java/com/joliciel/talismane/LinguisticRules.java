...
public interface LinguisticRules {
   ...
   * characters with diacritics. For example, in French, E will return e, é, è,
   * ë, ê. Order can be important, since, when looking for the lowercase
   * equivalent of an uppercase word, the letters will be replaced in the order
   * given, and the first match will be returned.
   */
