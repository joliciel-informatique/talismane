 ...
 *
 */
public class ParserFScoreCalculator implements ParseEvaluationObserver {
  private static final Logger LOG = LoggerFactory.getLogger(ParserFScoreCalculator.class);
