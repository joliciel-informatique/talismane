...
/**
 * Looks at all pos-tagged tokens preceding the reference token in sequence
 * (starting at the one closest to the reference token), and returns the first
 * one matching certain criteria.
 * 
 * @author Assaf Urieli
 *
 */
public final class BackwardSearchFeature extends AbstractAddressFunction {
	...
	public BackwardSearchFeature(PosTaggedTokenAddressFunction<ParseConfigurationWrapper> referenceTokenFeature,
