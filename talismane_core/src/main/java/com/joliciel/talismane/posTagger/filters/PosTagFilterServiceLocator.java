...
public class PosTagFilterServiceLocator {
	PosTagFilterServiceImpl posTagFilterService = null;
	private TalismaneServiceLocator talismaneServiceLocator;
	
	public PosTagFilterServiceLocator(TalismaneServiceLocator talismaneServiceLocator) {
