...
/**
 * All of the lemmas for a given pos-tagged token as supplied by the lexicon.
 * 
 * @author Assaf Urieli
 *
 */
public final class AllLemmasFeature<T> extends AbstractLexicalAttributeFeature<T>implements StringCollectionFeature<T> {
  private final List<String> attributes = new ArrayList<>(1);

  public AllLemmasFeature(PosTaggedTokenAddressFunction<T> addressFunction) {
