 ...
 * we skip all tokens in this sequence before trying to match.
 * 
 ...
 * oodles of obvious cases. Furthermore, we have virtually eliminated strange
 * broken compounds, which was possible lower-down in the beam using the
 * interval approach, because the n-gram features used in that approach
 * generally contained no counter-examples, leading to the "missing category"
 * phenomenon with a relatively high score for the missing category.
 * 
 * @author Assaf Urieli
 *
 */
