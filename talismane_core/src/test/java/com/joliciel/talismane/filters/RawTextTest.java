...
public class RawTextTest {
	...
	public void testGetDetectedSentences() throws Exception {
		...
		sentenceBoundaries.add(new Annotation<>("Sentence 1 Sentence 2".length(), "Sentence 1 Sentence 2.".length(), new SentenceBoundary()));
		sentenceBoundaries
				.add(new Annotation<>("Sentence 1 Sentence 2. Sentence 3".length(), "Sentence 1 Sentence 2. Sentence 3.".length(), new SentenceBoundary()));
