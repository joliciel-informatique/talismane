...
public class TokenPatternImplTest {
	...
	public void testMatch2(@NonStrict final Sentence sentence) {
		...
		new NonStrictExpectations() {
			{
				sentence.getText(); returns ("Qu'ensuite il aille...");
			}
		};
		...
		TokenPatternImpl tokenPattern = new TokenPatternImpl("{(?![cdjlmnstCDJLMNST]\\z|qu\\z|jusqu\\z|puisqu\\z|lorsqu\\z|aujourd\\z|prud\\z|quelqu\\z|quoiqu\\z).+'}.+", Tokeniser.SEPARATORS);
	...
	public void testMatch3(@NonStrict final Sentence sentence) {
		...
		new NonStrictExpectations() {
			{
				sentence.getText(); returns ("Z'ensuite il aille...");
			}
		};
	...
	public void testMatch4(@NonStrict final Sentence sentence) {
		...
		new NonStrictExpectations() {
			{
				sentence.getText(); returns ("Aix-les-Bains");
			}
		};
